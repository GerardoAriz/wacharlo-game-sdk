 ...
 */
export type SDKEventType = 'INITIALIZE' | 'GAME_STARTED' | 'GAME_PAUSED' | 'GAME_RESUMED' | 'GAME_OVER' | 'DATA_UPDATED' | 'ACHIEVEMENT_UNLOCKED' | 'SHOW_LEADERBOARD' | 'REQUEST_LEADERBOARD' | 'REQUEST_EXIT' | 'REQUEST_PAUSE' | 'REQUEST_RESUME' | 'START_GAME' | 'RESTART_GAME' | 'LOAD_MINIGAME' | 'ADOPT_SESSION';
/**
